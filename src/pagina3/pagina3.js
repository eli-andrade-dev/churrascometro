document.addEventListener('DOMContentLoaded', function() {
    // Pegar os valores armazenados na sessionStorage
    ...
    // Exibe as quantidades na tabela
...
const novaConsulta = document.querySelector('.novaConsulta');
